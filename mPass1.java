...
public class Pass1 {
	public static void main(String[] args) {
		...
		try {
			String filename = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\INPUT\\Input.txt";
			fr = new FileReader(filename);
			input_file = new BufferedReader(fr);

			String filename1 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\MDT.txt";
			fw = new FileWriter(filename1);
			mdt_file = new BufferedWriter(fw);

			String f1 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\PNTAB.txt";
			FileWriter fw1 = new FileWriter(f1);
			BufferedWriter pn_file = new BufferedWriter(fw1);

			String f2 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\EVNTAB.txt";
			FileWriter fw2 = new FileWriter(f2);
			BufferedWriter evn_file = new BufferedWriter(fw2);

			String f3 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\SSNTAB.txt";
			FileWriter fw3 = new FileWriter(f3);
			BufferedWriter ssN_file = new BufferedWriter(fw3);

			String f4 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\MNT.txt";
			FileWriter fw4 = new FileWriter(f4);
			BufferedWriter mnt_file = new BufferedWriter(fw4);

			String f5 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\KPDTAB.txt";
			FileWriter fw5 = new FileWriter(f5);
			BufferedWriter kpd_file = new BufferedWriter(fw5);

			String f6 = "C:\\Users\\21ksh\\eclipse-workspace\\Macro Pass 1\\OUTPUT\\SSTAB.txt";
